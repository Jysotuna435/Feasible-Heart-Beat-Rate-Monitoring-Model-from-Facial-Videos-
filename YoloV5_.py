...
class YOLOv5:
    ...
    def __init__(self, path,hidden_neuron,steps_per_epoch, activation, conf_thres=0.7, iou_thres=0.5,official_nms=False):
        self.conf_threshold = conf_thres
        self.iou_threshold = iou_thres
        self.official_nms = official_nms
        self.hidden_neruron = hidden_neuron
